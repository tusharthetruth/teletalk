...
public class HomeModel {
    ...
    public static ArrayList<HomeModel> getHomeList() {
        ...
        Integer[] iconList = {R.drawable.wallet_scroll, R.drawable.profile_scroll, R.drawable.invite_friends_scroll,
                ...
                , R.drawable.directcall_scroll, R.drawable.airtime_scroll, R.drawable.databundle_scroll, R.drawable.pbx_scroll
                , R.drawable.electricy_billpay_scroll, R.drawable.tv_bill_scroll, R.drawable.video_bill, R.drawable.settings_scroll,
                R.drawable.why_scroll, R.drawable.vouchare_recharge_scorll, R.drawable.interswitch_scroll, R.drawable.logout_scroll};
        String[] colorList = {
                "#3398dc",
                "#39a8f0",
                "#268bcf",
        ...
        String[] titles = {
                ...
                C.Companion.getTC(), C.Companion.getVR(), C.Companion.getIOPG(), C.Companion.getLOGOUT()
        };
