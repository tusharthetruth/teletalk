...
package com.chatapp.sip.utils.accessibility;
	...
	public static AccessibilityWrapper getInstance() {
		if(instance == null) {
			if(Compatibility.isCompatible(4)) {
			    instance = new com.chatapp.sip.utils.accessibility.Accessibility4();
			}else {
			    instance = new com.chatapp.sip.utils.accessibility.Accessibility3();
			}
		}
