 ...
 * 
 */
package com.chatapp.sip.utils.clipboard;
    ...
    public static ClipboardWrapper getInstance(Context context) {
        if(instance == null) {
            if(Compatibility.isCompatible(11)) {
                instance = new com.chatapp.sip.utils.clipboard.Clipboard11();
            }else {
                instance = new com.chatapp.sip.utils.clipboard.Clipboard1();
            }
            if(instance != null) {
