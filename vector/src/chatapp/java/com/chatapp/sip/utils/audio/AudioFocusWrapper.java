...
package com.chatapp.sip.utils.audio;
    ...
    public static AudioFocusWrapper getInstance() {
        if (instance == null) {
            if (Compatibility.isCompatible(17)) {
                instance = new com.chatapp.sip.utils.audio.AudioFocus17();
            } else if (Compatibility.isCompatible(8)) {
                instance = new com.chatapp.sip.utils.audio.AudioFocus8();
            } else {
                instance = new com.chatapp.sip.utils.audio.AudioFocus3();
            }
        }
