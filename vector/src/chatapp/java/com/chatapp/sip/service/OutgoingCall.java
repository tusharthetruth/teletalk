...
//import com.chatapp.sip.ui.outgoingcall.OutgoingCallChooser;
		...
		if (action.equals(Intent.ACTION_NEW_OUTGOING_CALL)) {
			...
			if (prefsWrapper.isValidConnectionForOutgoing() || potentialHandlers.size() > 1) {
				...
				if (gsmCallHandlerId == null) {
					gsmCallHandlerId = CallHandlerPlugin.getAccountIdForCallHandler(aContext, (new ComponentName(aContext, com.chatapp.sip.plugins.telephony.CallHandler.class)).flattenToString());
				}
				...
				Log.d(THIS_FILE, "Start outgoing call chooser for MobileSoftphone");
