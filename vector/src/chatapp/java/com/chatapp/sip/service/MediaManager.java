...
import com.chatapp.sip.utils.Ringer;
import com.chatapp.sip.utils.accessibility.AccessibilityWrapper;
import com.chatapp.sip.utils.audio.AudioFocusWrapper;
import com.chatapp.sip.utils.bluetooth.BluetoothWrapper;
import com.chatapp.sip.utils.bluetooth.BluetoothWrapper.BluetoothChangeListener;
		...
		if(winfo != null) {
			...
			if(service.getPrefs().getPreferenceBooleanValue(SipConfigManager.KEEP_AWAKE_IN_CALL)) {
				if(screenLock == null) {
		            ...
		            screenLock = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK | PowerManager.ON_AFTER_RELEASE, "com.cja.onIncomingCall.SCREEN");
