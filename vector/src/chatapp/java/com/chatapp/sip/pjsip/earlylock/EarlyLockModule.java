...
package com.chatapp.sip.pjsip.earlylock;
...
import com.chatapp.sip.pjsip.PjSipService.PjsipModule;
...
public class EarlyLockModule implements PjsipModule {
    ...
    private class WorkLocker extends Thread {
        ...
        WorkLocker(long time) {
            lockTime = time;
            wl = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.cja.earlylock");
            wl.acquire();
        }
