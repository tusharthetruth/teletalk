 ...
 * Use the {@link ContactChooserFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ContactChooserFragment extends ListFragment implements
...
*/
        ...
        if (mPreviouslySelectedSearchItem == 0) {
            ...
            if (getActivity() != null) {
                if (PermissionsToolsKt.checkPermissions(PermissionsToolsKt.PERMISSIONS_FOR_MEMBERS_SEARCH, this, PermissionsToolsKt.PERMISSION_REQUEST_CODE))
                    ...
                    getLoaderManager().initLoader(ContactsListFragment.ContactsQuery.QUERY_ID, null, this);
            }
        }
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        MenuItem itemS = menu.findItem(R.id.action_sync_contacts);
        itemS.setVisible(false);
        MenuItem item = menu.findItem(R.id.action_search);
        sv = new SearchView(((ContactChooserActivity) getActivity()).getSupportActionBar().getThemedContext());
        ...
        sv.setOnCloseListener(new SearchView.OnCloseListener() {
            ...
            public boolean onClose() {
                ...
                ((ContactChooserActivity) getActivity()).getSupportActionBar().setTitle(R.string.title_contacts);
                return true;
            }
        });
    ...
    public boolean onQueryTextChange(String newText) {
        if (isLocalContacts) {
            ...
            if (getActivity() != null) {
                if (PermissionsToolsKt.checkPermissions(PermissionsToolsKt.PERMISSIONS_FOR_MEMBERS_SEARCH, this, PermissionsToolsKt.PERMISSION_REQUEST_CODE))
                    getLoaderManager().restartLoader(ContactsListFragment.ContactsQuery.QUERY_ID, null, this);
            }
        }
        return true;
    }
  ...
  */
            ...
            final String ContactID = cursor.getString(ContactsListFragment.ContactsQuery.ID);
...
//            getActivity().startActivity(intent);
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        if (id == ContactsListFragment.ContactsQuery.QUERY_ID) {
            Uri contentUri;
            ...
            if (mSearchTerm == null) {
                ...
                // Contacts table
                contentUri = ContactsListFragment.ContactsQuery.CONTENT_URI;
            } else {
                // Since there's a search string, use the special content Uri that searches the
                // Contacts table. The URI consists of a base Uri and the search string.
                contentUri =
                        Uri.withAppendedPath(ContactsListFragment.ContactsQuery.FILTER_URI, Uri.encode(mSearchTerm));
            }
            ...
            return new CursorLoader(getActivity(),
                    contentUri,
                    ContactsListFragment.ContactsQuery.PROJECTION,
                    ContactsListFragment.ContactsQuery.SELECTION,
                    null,
                    ContactsListFragment.ContactsQuery.SORT_ORDER);
        }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        if (loader.getId() == ContactsListFragment.ContactsQuery.QUERY_ID) {
            /*
            if (Settings.hasContactPermission) {
            ...
            if (mIsTwoPaneLayout && !TextUtils.isEmpty(mSearchTerm) && mSearchQueryChanged) {
                ...
                if (data != null && data.moveToPosition(mPreviouslySelectedSearchItem)) {
                    ...
                    final Uri uri = Uri.withAppendedPath(
                            ContactsContract.Contacts.CONTENT_URI, String.valueOf(data.getLong(ContactsListFragment.ContactsQuery.ID)));
    ...
    private class ContactsAdapter extends CursorAdapter implements SectionIndexer {
        ...
        public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
            ...
            final ContactsAdapter.ViewHolder holder = new ContactsAdapter.ViewHolder();
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            final String ContactsID = cursor.getString(ContactsListFragment.ContactsQuery.ID);
    ...
    public interface ContactsQuery {
        ...
        final static String SELECTION =
                (Utils.hasHoneycomb() ? ContactsContract.Contacts.DISPLAY_NAME_PRIMARY : ContactsContract.Contacts.DISPLAY_NAME) +
                        "<>''" + " AND " + ContactsContract.Contacts.IN_VISIBLE_GROUP + "=1 AND (" + ContactsContract.Contacts.HAS_PHONE_NUMBER + " != 0 )";
