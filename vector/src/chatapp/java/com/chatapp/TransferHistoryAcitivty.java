...
//                                        ArrayList<TransferItem> arrayList = new ArrayList<TransferItem>();
//                                        for (int i =0; i<jsonArray.length();i++){
//                                            JSONObject jsonObject = new JSONObject(jsonArray.get(i).toString());
//                                            TransferItem transferItem = new TransferItem(jsonObject.getString("sender"),jsonObject.getString("reciever"),jsonObject.getString("amount"),jsonObject.getString("currency"),jsonObject.getString("date"));
//                                            arrayList.add(transferItem);
//                                        }
//                                        mAdapter = new TransferAdapter(TransferHistoryAcitivty.this,R.layout.adapter_transfer_item,arrayList);
